# Positioning (own truth)

**ICP:** Head of IT Compliance / CISO in European Fintech and mid-size banks (100–500 FTE) facing DORA/NIS2 deadlines in 2026.
...
**Functional SLA (not latency SLA):** Identical repository state yields identical `replay_hash` and artifact hashes on any host (deterministic execution).
