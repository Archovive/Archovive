...
**Navigation:** [Decision Hub](../00_decision_hub.md) · [Docs hub](../README.md) · [← Simulate](../02-simulate/README.md) · [Next: Governance →](../04-governance/README.md) · [MCP →](../09-mcp/README.md)
